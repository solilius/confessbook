...
* after you are verified you need to request permissions for _manage_pages_ and _publish_pages_. and give them all the data they need to access the app and check the app( url to the site, user and password). you also need to record a video of how to you are using the permissions. (feel free to [contact me](mailto:sol.elan.x@gmail.com) if you need help with this process),
